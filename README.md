...
![ckey](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/ckey.png)
...
![extract_ckey](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/extract_ckey.gif) 

Once you have received the private key, you can analyze it using the **ckey_analyzer.rb** script and check if it is correct.

![ckey_analyzer](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/ckey_analyzer.gif)
...
![bruteforce_ckey](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/bruteforce_ckey.gif)
...
![extract_password](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/extract_password.gif)

Then, you can check this one too:

![password_analyzer](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/password_analyzer.gif)
...
![compile_password](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/assets/compile_password.gif)
...
- [X] [bruteforce_ckey.rb](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/bruteforce_ckey.rb) has become available
- [X] a new script has been created: [password_analyzer.rb](https://github.com/Jeysi50/Unlock-Bitcoin-Core-Wallet/blob/main/password_analyzer.rb)
- [X] the scripts support disabling colors, using the `-dc` argument
- [X] new design updates
- [X] minor code improvements

## Contact
You can contact me at the email anndrey2090@gmail.com for any questions. Don't open issues unless you're very sure of the problem. **compile_password.rb** script is not for free. 
You can buy the compile_password.rb script directly here:https://satoshidisk.com/pay/CQ2ThH   Price: 0.01575000 BTC
